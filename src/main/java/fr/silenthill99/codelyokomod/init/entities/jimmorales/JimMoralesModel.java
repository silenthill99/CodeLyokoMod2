package fr.silenthill99.codelyokomod.init.entities.jimmorales;// Made with Blockbench 4.2.4
...
public class JimMoralesModel<T extends JimMorales> extends EntityModel<T> {
