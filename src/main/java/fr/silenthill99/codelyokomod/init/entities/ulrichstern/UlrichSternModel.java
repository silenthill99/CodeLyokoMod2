package fr.silenthill99.codelyokomod.init.entities.ulrichstern;// Made with Blockbench 4.2.2
...
public class UlrichSternModel<T extends UlrichStern> extends EntityModel<T> {
