package fr.silenthill99.codelyokomod.init.entities.jeremybelpois;// Made with Blockbench 4.2.2
...
public class JeremyBelpoisModel<T extends JeremyBelpois> extends EntityModel<T> {
