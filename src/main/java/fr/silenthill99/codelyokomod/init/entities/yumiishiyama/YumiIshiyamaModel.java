package fr.silenthill99.codelyokomod.init.entities.yumiishiyama;// Made with Blockbench 4.2.2
...
public class YumiIshiyamaModel<T extends YumiIshiyama> extends EntityModel<T> {
