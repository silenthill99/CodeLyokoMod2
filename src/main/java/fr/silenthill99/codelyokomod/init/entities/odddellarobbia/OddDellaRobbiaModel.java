package fr.silenthill99.codelyokomod.init.entities.odddellarobbia;// Made with Blockbench 4.2.2
...
public class OddDellaRobbiaModel<T extends OddDellaRobbia> extends EntityModel<T> {
