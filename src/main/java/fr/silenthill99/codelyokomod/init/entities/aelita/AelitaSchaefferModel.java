package fr.silenthill99.codelyokomod.init.entities.aelita;// Made with Blockbench 4.2.2
...
public class AelitaSchaefferModel<T extends AelitaSchaeffer> extends EntityModel<T> {
