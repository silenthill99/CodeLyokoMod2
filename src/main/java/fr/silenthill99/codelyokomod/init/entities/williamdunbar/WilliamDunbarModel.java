package fr.silenthill99.codelyokomod.init.entities.williamdunbar;// Made with Blockbench 4.2.2
...
public class WilliamDunbarModel<T extends WilliamDunbar> extends EntityModel<T> {
